...
<div>
            ...
            <div class="collapse navbar-collapse container-fluid" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav col-lg-8">
                    ...
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page" href="/furama?action=listCustomer">Khách Hàng</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page" href="/employee">Nhân Viên</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page" href="/facility">Dịch Vụ</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <img src="http://datphongresort.com/wp-content/uploads/2020/10/khu-nghi-duong-furama.jpg" style="width: 100%"/>
        </div>
    </div>
