...
<div>
                ...
                <div class="navbar-nav col-lg-8">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page" href="/furama">Trang
                                Chủ</a>
                        </button>
                    </div>
                    <!--DropDowns2-->
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page"
                    ...
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page"
                               href="/employee">Nhân Viên</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                            <a class="thea nav-link active a " style="color: white" aria-current="page"
                               href="/facility">Dịch Vụ</a>
                        </button>
                    </div>
                    <div class="btn-group" style="margin-left: 30px">
                        <button type="button" class="btn btn-info">
                ...
                <div class="col-lg-3">
                    <form class="d-flex" action="/furama?action=search" method="post">
                        ...
                        <input class="form-control me-2" type="search" placeholder="Địa Chỉ"
                               aria-label="Nhập Địa Chỉ" name="addressInput">
    ...
    <div class="col-lg-12" style="text-align: center;background-color: lightyellow"><h1 style="margin: 0">Danh Sách
        Khách Hàng</h1></div>
    <button class="btn btn-success"><a style="text-decoration: none;color: white" href="/furama?action=create">Thêm
        Mới</a></button>
    <div class="col-lg-12">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-warning"><a style="color: white; text-decoration: none"
                           href="/furama?action=update&id=${listCustomer.getId()}">Sửa</a>
                        </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <span><h4 style="color: red" id="nameInput"></h4></span>
            </div>
